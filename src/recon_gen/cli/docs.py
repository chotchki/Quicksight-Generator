...
from recon_gen.cli._helpers import l2_instance_option, load_config
...
# (``<repo>/src/recon_gen/mkdocs.yml``) and installed mode
# (``<site-packages>/recon_gen/mkdocs.yml``). One level up from
...
def _bundled_dir(name: str) -> Path:
    ...
    traversable = files("recon_gen") / name
