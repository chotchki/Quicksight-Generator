"""``python -m recon_gen.common.html`` — direct smoke runner.

Equivalent to ``recon-gen dashboards --port 8765``, but
...
For anything operator-facing prefer the CLI subcommand:
    ...
    recon-gen dashboards -c config.yaml --l2 run/sasquatch_pr.yaml
