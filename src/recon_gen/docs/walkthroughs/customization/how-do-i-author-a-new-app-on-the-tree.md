...
- **`src/recon_gen/apps/executives/app.py`** — the worked example.
...
- **`src/recon_gen/apps/executives/datasets.py`** — the dataset
...
from recon_gen.common.tree.filters import FilterGroup
from recon_gen.apps.myapp.datasets import (
    DS_MYAPP_FOO,
    build_all_datasets,
)
