...
Produces deterministic SQL INSERT statements against the canonical
schema (see ``quicksight_gen.schema.generate_schema_sql``).  All
dates are relative to an anchor date (default: today) so the data
always looks fresh.
